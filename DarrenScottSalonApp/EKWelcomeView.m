...
//    self.scrollView.backgroundColor                = [UIColor colorWithPatternImage:[UIImage imageNamed:@"bg1"]];
...
- (void)layoutSubviews
{
	...
	self.scrollView.frame = CGRectMake(0.0f, self.frame.origin.y, self.bounds.size.width, self.bounds.size.height - 90.0f);
	...
	for (NSUInteger i = 0; i < [self.pages count]; i++) {
		[[[self.scrollView subviews] objectAtIndex:i] setFrame:CGRectMake(0.0f + (i * self.bounds.size.width), 0.0f,
		                                                                  self.bounds.size.width + 20.0f, self.bounds.size.height)];
...
//        		[[[self.scrollView subviews] objectAtIndex:i] setFrame:CGRectMake(0.0f, self.frame.origin.y + 40.0f, self.bounds.size.width, self.bounds.size.height - 90.0f)];
